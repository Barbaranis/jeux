console.log("Chargement de `scriptechec.js`...");
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!chessboard) {
        console.error("⚠️ Erreur : Élément #chessboard introuvable !");
        return;
    }

    if (typeof Chess === "undefined" || typeof Chessboard === "undefined") {
        console.error("⚠️ Erreur : Chess.js ou Chessboard.js n'est pas chargé !");
        return;
    }
    ...
    function updateStatus() {
        statusText.textContent = game.in_checkmate() ? "Échec et mat !" : `Tour des ${game.turn() === "w" ? "Blancs" : "Noirs"}`;
    }
